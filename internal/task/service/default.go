...
// DefaultTaskAdapter is a default implementation of the Adapter interface
type DefaultTaskAdapter struct {
	logger telemetry.Logger
}

// NewDefaultTaskAdapter creates a new default task adapter
func NewDefaultTaskAdapter(logger telemetry.Logger) Adapter[*DefaultTask, DefaultCreateRequest, DefaultApproveRequest, DefaultTaskUpdate] {
...
func (a *DefaultTaskAdapter) ConvertTaskUpdates(updates []DefaultTaskUpdate) []Update {
	var sdkUpdates []Update
	for _, update := range updates {
		sdkUpdates = append(sdkUpdates, Update{
			Type:        update.Type,
