...
type AIPlanner interface {
	GeneratePlan(ctx context.Context, task *CoreTask) (string, error)
}
...
func NewSimpleLLMPlanner(llm contracts.LLM, logger telemetry.Logger) *SimpleLLMPlanner {
	if logger == nil {
...
func NewSimpleLLMPlannerWithSystemPrompt(llm contracts.LLM, logger telemetry.Logger, systemPrompt string) *SimpleLLMPlanner {
...
func (p *SimpleLLMPlanner) GeneratePlan(ctx context.Context, task *CoreTask) (string, error) {
	if p.llm == nil {
	...
	response, err := p.llm.Generate(ctx, prompt, func(opts *contracts.GenerateOptions) {
...
func (p *MockAIPlanner) GeneratePlan(ctx context.Context, task *CoreTask) (string, error) {
...
// CorePlanner implements the contracts.TaskPlanner interface
...
func NewCorePlanner(logger telemetry.Logger) contracts.TaskPlanner {
...
func NewCorePlannerWithAI(logger telemetry.Logger, aiPlanner AIPlanner) contracts.TaskPlanner {
	return &CorePlanner{
		logger:    logger,
		aiPlanner: aiPlanner,
	}
...
func (p *CorePlanner) CreatePlan(ctx context.Context, taskObj interface{}) (string, error) {
	// Canonical tasks carry the planning context.
	task, ok := taskObj.(*CoreTask)
	if !ok {
...
func (p *CorePlanner) AnalyzeTaskContext(task *CoreTask) map[string]interface{} {
...
func (p *CorePlanner) SerializeTaskForAI(task *CoreTask) (string, error) {
