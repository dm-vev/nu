...
func StartRequestTracing(ctx context.Context, tracer contracts.Tracer, requestID string) (context.Context, contracts.Span) {
	if tracer == nil {
...
func WithRequestTracing(ctx context.Context, tracer contracts.Tracer, requestID string, orgID string) (context.Context, contracts.Span) {
