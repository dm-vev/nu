...
func TestAzureOpenAINewClientWithOptions(t *testing.T) {
	apiKey := "test-api-key"
	baseURL := "https://test.openai.azure.com"
	deployment := "test-deployment"
	model := "gpt-4"
...
func TestAzureOpenAIClientName(t *testing.T) {
...
func TestAzureOpenAIClientSupportsStreaming(t *testing.T) {
	client := NewClient("test-key", "https://test.openai.azure.com", "test-deployment")
...
func TestAzureOpenAIGetModel(t *testing.T) {
	model := "gpt-4"
	client := NewClient(
		"test-key",
...
func TestAzureOpenAIGetDeployment(t *testing.T) {
	deployment := "test-deployment"
...
func TestAzureOpenAINewClientFromRegion(t *testing.T) {
	apiKey := "test-api-key"
	region := "eastus"
	resourceName := "test-resource"
	deployment := "test-deployment"
...
func TestAzureOpenAIGetRegion(t *testing.T) {
	region := "westus2"
...
func TestAzureOpenAIGetResourceName(t *testing.T) {
...
func TestAzureOpenAIGetBaseURL(t *testing.T) {
	baseURL := "https://test.openai.azure.com"
...
func TestAzureOpenAIIsReasoningModel(t *testing.T) {
	tests := []struct {
		model    string
		expected bool
	}{
	...
	for _, test := range tests {
		result := azureOpenAIIsReasoningModel(test.model)
...
func TestAzureOpenAIGetTemperatureForModel(t *testing.T) {
	tests := []struct {
		model       string
		requestTemp float64
		expected    float64
...
func TestAzureOpenAIWithTemperatureOption(t *testing.T) {
	temp := 0.8
...
func TestAzureOpenAIWithTopPOption(t *testing.T) {
	topP := 0.9
	options := &contracts.GenerateOptions{}
...
func TestAzureOpenAIWithFrequencyPenaltyOption(t *testing.T) {
	penalty := 0.5
	options := &contracts.GenerateOptions{}
...
func TestAzureOpenAIWithPresencePenaltyOption(t *testing.T) {
	penalty := 0.3
	options := &contracts.GenerateOptions{}
...
func TestAzureOpenAIWithStopSequencesOption(t *testing.T) {
...
func TestAzureOpenAIWithSystemMessageOption(t *testing.T) {
...
func TestAzureOpenAIWithResponseFormatOption(t *testing.T) {
...
func TestAzureOpenAIWithReasoningOption(t *testing.T) {
...
func TestAzureOpenAIConvertToOpenAISchema(t *testing.T) {
	client := NewClient("test-key", "https://test.openai.azure.com", "test-deployment")
...
func TestAzureOpenAIReasoningEffort(t *testing.T) {
...
/*
func TestAzureOpenAIGenerateIntegration(t *testing.T) {
	...
	client := NewAzureOpenAI(apiKey, baseURL, deployment)
