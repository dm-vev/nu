...
type anthropicCacheRequestBuilder struct {
	config *contracts.CacheConfig
}

// anthropicNewCacheRequestBuilder creates a new cache request builder with the given config.
func anthropicNewCacheRequestBuilder(config *contracts.CacheConfig) *anthropicCacheRequestBuilder {
	return &anthropicCacheRequestBuilder{config: config}
}

// HasCacheOptions returns true if any caching options are enabled.
func (b *anthropicCacheRequestBuilder) HasCacheOptions() bool {
	if b.config == nil {
		return false
	}
...
func (b *anthropicCacheRequestBuilder) getCacheControl() *CacheControl {
...
func (b *anthropicCacheRequestBuilder) BuildSystemContent(system string) (json.RawMessage, error) {
...
func (b *anthropicCacheRequestBuilder) BuildMessages(messages []Message) (json.RawMessage, error) {
...
func (b *anthropicCacheRequestBuilder) BuildTools(tools []Tool) (json.RawMessage, error) {
...
func (b *anthropicCacheRequestBuilder) BuildCacheableRequest(req *CompletionRequest) (*CacheableCompletionRequest, error) {
