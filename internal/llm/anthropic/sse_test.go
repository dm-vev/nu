...
func TestAnthropicParseSSELine(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := anthropicParseSSELine(tt.line)
...
func TestAnthropicConvertAnthropicEventToStreamEvent(t *testing.T) {
	client := &Client{}

	tests := []struct {
		name           string
		anthropicEvent *SSEEvent
		expectedType   contracts.StreamEventType
		expectError    bool
	}{
		{
			...
			expectedType: contracts.StreamEventMessageStart,
			expectError:  false,
		},
		{
			...
			expectedType: contracts.StreamEventContentDelta,
			expectError:  false,
		},
		{
			...
			expectedType: contracts.StreamEventMessageStop,
			expectError:  false,
		},
		{
			name: "Error event",
			...
			expectedType: contracts.StreamEventError,
			expectError:  false,
		},
		{
...
func TestAnthropicMessageStartData(t *testing.T) {
...
func TestAnthropicContentBlockDeltaData(t *testing.T) {
...
func TestAnthropicGenerateWithMemory(t *testing.T) {
	...
	memory := &anthropicMockMemory{
		messages: []contracts.Message{
			...
			{Role: contracts.RoleUser, Content: "How are you?"},
		},
	}
