...
func TestDeepSeekConvertMemoryMessageSimple(t *testing.T) {
	builder := deepSeekNewMessageHistoryBuilder(telemetry.NewLogger())

	tests := []struct {
		name        string
		input       contracts.Message
		wantRole    string
		wantContent string
	}{
		{
...
func TestDeepSeekConvertMemoryMessageWithToolCalls(t *testing.T) {
	builder := deepSeekNewMessageHistoryBuilder(telemetry.NewLogger())
...
func TestDeepSeekConvertMemoryMessageToolResult(t *testing.T) {
	builder := deepSeekNewMessageHistoryBuilder(telemetry.NewLogger())
