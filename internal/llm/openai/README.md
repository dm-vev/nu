...
This package provides a client for interacting with the OpenAI API, implementing the `contracts.LLM` interface.
...
- Direct implementation of the `contracts.LLM` interface
...
```go
import "github.com/dm-vev/nu/internal/llm/openai"
