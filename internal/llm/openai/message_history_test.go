...
func TestOpenAIMessageHistoryBuilder_BuildMessages(t *testing.T) {
	logger := telemetry.NewLogger()
	builder := openAINewMessageHistoryBuilder(logger)
...
// openAIMockMemory is a simple mock implementation for testing
