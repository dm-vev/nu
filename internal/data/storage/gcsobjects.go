...
func (s *GCSStorage) Store(ctx context.Context, image *contracts.GeneratedImage, metadata Metadata) (string, error) {
...
func (s *GCSStorage) Delete(ctx context.Context, url string) error {
...
func (s *GCSStorage) Get(ctx context.Context, url string) ([]byte, error) {
	objectPath := s.urlToObjectPath(url)
	if objectPath == "" {
