...
func TestStoreEntities(t *testing.T) {
	...
	t.Run("stores single entity", func(t *testing.T) {
		...
		err := store.StoreEntities(ctx, []contracts.Entity{entity})
	...
	t.Run("returns error for invalid entity", func(t *testing.T) {
		// Missing ID
		err := store.StoreEntities(ctx, []contracts.Entity{
...
func TestStoreRelationships(t *testing.T) {
	...
	t.Run("stores relationship successfully", func(t *testing.T) {
		...
		err := store.StoreRelationships(ctx, []contracts.Relationship{rel})
		require.NoError(t, err)

		// Verify relationship
		rels, err := store.GetRelationships(ctx, "rel-entity-1", contracts.DirectionOutgoing)
		require.NoError(t, err)
		assert.Len(t, rels, 1)
	...
	t.Run("returns error for invalid relationship", func(t *testing.T) {
		// Missing source ID
		err := store.StoreRelationships(ctx, []contracts.Relationship{
...
func TestGetRelationships(t *testing.T) {
	...
	t.Run("gets outgoing relationships", func(t *testing.T) {
		results, err := store.GetRelationships(ctx, "get-rel-1", contracts.DirectionOutgoing)
		require.NoError(t, err)
	...
	t.Run("gets incoming relationships", func(t *testing.T) {
		results, err := store.GetRelationships(ctx, "get-rel-1", contracts.DirectionIncoming)
		require.NoError(t, err)
		assert.Len(t, results, 1)
	...
	t.Run("gets both directions", func(t *testing.T) {
		results, err := store.GetRelationships(ctx, "get-rel-1", contracts.DirectionBoth)
		require.NoError(t, err)
...
func TestSearch(t *testing.T) {
	...
	t.Run("filters by entity type", func(t *testing.T) {
		results, err := store.Search(ctx, "technology", 10, contracts.WithEntityTypes("Organization"))
		require.NoError(t, err)
