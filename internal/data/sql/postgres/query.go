...
func (c *Collection) Query(ctx context.Context, filter map[string]interface{}, options ...contracts.QueryOption) ([]map[string]interface{}, error) {
...
func (c *TransactionCollection) Query(ctx context.Context, filter map[string]interface{}, options ...contracts.QueryOption) ([]map[string]interface{}, error) {
	// Get organization ID from context
	orgID, err := multitenancy.GetOrgID(ctx)
	if err != nil {
		return nil, fmt.Errorf("failed to get organization ID: %w", err)
