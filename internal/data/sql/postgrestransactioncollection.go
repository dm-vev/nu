...
type PostgresTransactionCollection struct {
	tx   *sql.Tx
	name string
}

// Insert inserts a document into the collection within a transaction
func (c *PostgresTransactionCollection) Insert(ctx context.Context, data map[string]interface{}) (string, error) {
...
func (c *PostgresTransactionCollection) Get(ctx context.Context, id string) (map[string]interface{}, error) {
	// Get organization ID from context
	orgID, err := multitenancy.GetOrgID(ctx)
	if err != nil {
...
func (c *PostgresTransactionCollection) Update(ctx context.Context, id string, data map[string]interface{}) error {
	// Get organization ID from context
	orgID, err := multitenancy.GetOrgID(ctx)
	if err != nil {
		return fmt.Errorf("failed to get organization ID: %w", err)
...
func (c *PostgresTransactionCollection) Delete(ctx context.Context, id string) error {
	// Get organization ID from context
	orgID, err := multitenancy.GetOrgID(ctx)
	if err != nil {
		return fmt.Errorf("failed to get organization ID: %w", err)
