...
type MockVectorStore struct {
	documents map[string][]contracts.Document
	lastOrgID string
}

func NewMockVectorStore() *MockVectorStore {
	return &MockVectorStore{
		documents: make(map[string][]contracts.Document),
	}
}

func (s *MockVectorStore) Store(ctx context.Context, documents []contracts.Document, options ...contracts.StoreOption) error {
	// Get organization ID
...
func (s *MockVectorStore) Search(ctx context.Context, query string, limit int, options ...contracts.SearchOption) ([]contracts.SearchResult, error) {
	return nil, nil
}

func (s *MockVectorStore) SearchByVector(ctx context.Context, vector []float32, limit int, options ...contracts.SearchOption) ([]contracts.SearchResult, error) {
	return nil, nil
}

func (s *MockVectorStore) Delete(ctx context.Context, ids []string, options ...contracts.DeleteOption) error {
	return nil
}

func (s *MockVectorStore) Get(ctx context.Context, ids []string) ([]contracts.Document, error) {
	return nil, nil
}
