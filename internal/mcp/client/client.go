...
func NewClient(ctx context.Context, transport mcp.Transport) (contracts.MCPServer, error) {
	return NewClientWithLogger(ctx, transport, telemetry.NewLogger())
}

// NewClientWithLogger connects to an MCP server using the provided logger.
func NewClientWithLogger(ctx context.Context, transport mcp.Transport, logger telemetry.Logger) (contracts.MCPServer, error) {
