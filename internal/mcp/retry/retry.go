...
// New creates a new MCP server wrapper with retry capabilities
func New(server contracts.MCPServer, config *Config) contracts.MCPServer {
	if config == nil {
...
func (r *RetryableServer) ListTools(ctx context.Context) ([]contracts.MCPTool, error) {
	var result []contracts.MCPTool
...
func (r *RetryableServer) CallTool(ctx context.Context, name string, args interface{}) (*contracts.MCPToolResponse, error) {
	var result *contracts.MCPToolResponse
...
func (r *RetryableServer) ListResources(ctx context.Context) ([]contracts.MCPResource, error) {
	var result []contracts.MCPResource
...
func (r *RetryableServer) GetResource(ctx context.Context, uri string) (*contracts.MCPResourceContent, error) {
	var result *contracts.MCPResourceContent
...
func (r *RetryableServer) WatchResource(ctx context.Context, uri string) (<-chan contracts.MCPResourceUpdate, error) {
	return r.server.WatchResource(ctx, uri)
}

// ListPrompts lists prompts with retry logic
func (r *RetryableServer) ListPrompts(ctx context.Context) ([]contracts.MCPPrompt, error) {
	var result []contracts.MCPPrompt
...
func (r *RetryableServer) GetPrompt(ctx context.Context, name string, variables map[string]interface{}) (*contracts.MCPPromptResult, error) {
	var result *contracts.MCPPromptResult
...
func (r *RetryableServer) CreateMessage(ctx context.Context, request *contracts.MCPSamplingRequest) (*contracts.MCPSamplingResponse, error) {
	var result *contracts.MCPSamplingResponse
...
func (r *RetryableServer) GetServerInfo() (*contracts.MCPServerInfo, error) {
...
func (r *RetryableServer) GetCapabilities() (*contracts.MCPServerCapabilities, error) {
	// Delegate to underlying server - no retry needed for metadata access
