...
// NewGetContextTool creates a graph context tool.
func NewGetContextTool(store contracts.GraphRAGStore) *GetContextTool {
...
func (t *GetContextTool) Parameters() map[string]contracts.ParameterSpec {
...
func (t *GetContextTool) Execute(ctx context.Context, args string) (string, error) {
	...
	if len(params.RelationshipTypes) > 0 {
		opts = append(opts, graph.WithRelationshipTypes(params.RelationshipTypes...))
	}
...
func formatGraphContext(graphCtx *contracts.GraphContext) string {
