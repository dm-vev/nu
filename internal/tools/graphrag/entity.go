...
// NewAddEntityTool creates a graph entity tool.
func NewAddEntityTool(store contracts.GraphRAGStore) *AddEntityTool {
...
func (t *AddEntityTool) Parameters() map[string]contracts.ParameterSpec {
...
func (t *AddEntityTool) Execute(ctx context.Context, args string) (string, error) {
	...
	if err := t.store.StoreEntities(ctx, []contracts.Entity{entity}); err != nil {
