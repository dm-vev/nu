...
// NewAddRelationshipTool creates a graph relationship tool.
func NewAddRelationshipTool(store contracts.GraphRAGStore) *AddRelationshipTool {
...
func (t *AddRelationshipTool) Parameters() map[string]contracts.ParameterSpec {
...
func (t *AddRelationshipTool) Execute(ctx context.Context, args string) (string, error) {
	...
	if err := t.store.StoreRelationships(ctx, []contracts.Relationship{relationship}); err != nil {
