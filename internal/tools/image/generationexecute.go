...
func (t *GenerationTool) Run(ctx context.Context, input string) (string, error) {
	return t.Execute(ctx, input)
}

// Execute implements the tool execution
func (t *GenerationTool) Execute(ctx context.Context, args string) (string, error) {
	// Parse arguments
	var params struct {
...
func (t *GenerationTool) executeSingleShot(ctx context.Context, prompt, aspectRatio, outputFormat string) (string, error) {
	// Validate prompt
	if prompt == "" {
