...
func NewConversationBuffer(options ...Option) *ConversationBuffer {
	buffer := &ConversationBuffer{
		messages: make(map[string][]contracts.Message),
...
func (c *ConversationBuffer) AddMessage(ctx context.Context, message contracts.Message) error {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *ConversationBuffer) GetMessages(ctx context.Context, options ...contracts.GetMessagesOption) ([]contracts.Message, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func ConversationKey(ctx context.Context) (string, error) {
...
func (c *ConversationBuffer) GetConversationMessages(ctx context.Context, conversationID string) ([]contracts.Message, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *ConversationBuffer) GetConversationMessagesAcrossOrgs(conversationID string) ([]contracts.Message, string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
