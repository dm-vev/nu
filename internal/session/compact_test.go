...
func TestNUF091BranchSummaryFindsCommonAncestor(t *testing.T) {
	summary := BuildBranchSummary(
		[]Entry{compactEntry("root", 1, "", "", nil), compactEntry("left", 1, "", "", nil)},
		[]Entry{compactEntry("root", 1, "", "", nil), compactEntry("right", 1, "", "", nil)},
	)
...
func compactEntry(id string, tokens int, role string, toolCallID string, files []string) Entry {
