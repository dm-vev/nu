...
func TestMessageAppendTextCoalescesAdjacentTextParts(t *testing.T) {
	msg := NewAssistant()
	msg.AppendText("hel")
	msg.AppendText("lo")
...
func TestMessageThinkingAndToolPartsKeepOrdering(t *testing.T) {
	msg := NewAssistant()
...
func TestMessageReplaceTextDoesNotDeleteToolParts(t *testing.T) {
	msg := NewAssistant()
