...
func WithLLM(llm contracts.LLM) Option {
	return func(a *Agent) {
		a.llm = llm
	}
}
...
func WithMemory(memory contracts.Memory) Option {
	return func(a *Agent) {
		a.memory = memory
	}
}
...
func WithTracer(tracer contracts.Tracer) Option {
	return func(a *Agent) {
		a.tracer = tracer
	}
}
