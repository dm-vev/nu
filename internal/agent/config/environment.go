...
func LoadDeploymentConfigFromEnvironment(ctx context.Context) (map[string]string, error) {
...
func MergeDeploymentConfigWithViper(ctx context.Context, v *viper.Viper) (configsLoaded int, configsMerged int, err error) {
	...
	dynamicConfig, err := LoadDeploymentConfigFromEnvironment(ctx)
	if err != nil {
