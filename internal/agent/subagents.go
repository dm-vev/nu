...
func createSubAgentsFromConfig(subAgentConfigs map[string]agentconfig.AgentConfig, variables map[string]string, llm contracts.LLM, memory contracts.Memory, tracer contracts.Tracer, logger telemetry.Logger) ([]*Agent, error) {
