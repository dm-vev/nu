...
func (tf *ToolFactory) registerBuiltinTools() {
	...
	tf.builtinFactories["calculator"] = func(config map[string]interface{}) (contracts.Tool, error) {
		return tools.NewCalculator(), nil
	}
...
func (tf *ToolFactory) CreateTool(config agentconfig.ToolConfigYAML) (contracts.Tool, error) {
...
func (tf *ToolFactory) CreateToolWithParentConfig(config agentconfig.ToolConfigYAML, parentConfig *agentconfig.AgentConfig) (contracts.Tool, error) {
	switch config.Type {
	case "builtin":
...
func (tf *ToolFactory) createBuiltinTool(config agentconfig.ToolConfigYAML) (contracts.Tool, error) {
...
func (tf *ToolFactory) createCustomTool(config agentconfig.ToolConfigYAML) (contracts.Tool, error) {
...
func (tf *ToolFactory) createAgentToolWithParentConfig(config agentconfig.ToolConfigYAML, parentConfig *agentconfig.AgentConfig) (contracts.Tool, error) {
	if config.URL == "" {
		return nil, fmt.Errorf("agent tool requires URL")
	}
	if tf.remoteClientFactory == nil {
	...
	// Build agent options
	options := []Option{
		WithRemoteClient(config.URL, tf.remoteClientFactory(config.URL)),
...
func (tf *ToolFactory) createMCPTool(config agentconfig.ToolConfigYAML) (contracts.Tool, error) {
...
func (tf *ToolFactory) RegisterCustomTool(name string, factory func(map[string]interface{}) (contracts.Tool, error)) {
