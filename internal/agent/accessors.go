...
func (a *Agent) GetGeneratedAgentConfig() *agentconfig.AgentConfig {
	return a.generatedAgentConfig
}

// GetGeneratedTaskConfigs returns the automatically generated task configurations, if any
func (a *Agent) GetGeneratedTaskConfigs() agentconfig.TaskConfigs {
...
func (a *Agent) GetConfig() *agentconfig.AgentConfig {
