...
func (c *TraceCollector) getParentSpanID(ctx context.Context) string {
...
func (c *TraceCollector) getConversationID(ctx context.Context) string {
...
func (c *TraceCollector) getOrgID(ctx context.Context) string {
