...
func (c *TraceCollector) inferSpanType(name string) string {
...
func (c *TraceCollector) updateTraceSize(trace *Trace) {
...
func (c *TraceCollector) enforceRetentionLimits() {
...
func (c *TraceCollector) isTraceComplete(trace *Trace) bool {
...
func (c *TraceCollector) getTraceEndTime(trace *Trace) time.Time {
...
func (c *TraceCollector) countRunningTraces() int {
	count := 0
