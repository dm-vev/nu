...
func (r *RemoteAgentClient) RunStream(ctx context.Context, input string) (<-chan contracts.AgentStreamEvent, error) {
...
func (r *RemoteAgentClient) RunStreamWithAuth(ctx context.Context, input string, authToken string) (<-chan contracts.AgentStreamEvent, error) {
	if err := r.ensureConnected(); err != nil {
		return nil, err
	}
