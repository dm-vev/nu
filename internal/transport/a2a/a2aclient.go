...
// NewClient creates an A2A client that connects to the agent at the given URL.
...
// NewClientFromCard creates an A2A client from an already-resolved agent card.
