...
// RemoteAgentTool wraps an A2A client as a contracts.Tool so that a remote
...
var _ contracts.Tool = (*RemoteAgentTool)(nil)
...
func (t *RemoteAgentTool) Parameters() map[string]contracts.ParameterSpec {
