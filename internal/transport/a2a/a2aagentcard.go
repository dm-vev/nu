...
// CardBuilder constructs an A2A AgentCard from agent metadata.
...
// NewCardBuilder creates an A2A card builder with required fields.
...
func (b *CardBuilder) SetTools(tools []contracts.Tool) *CardBuilder {
	b.tools = tools
	return b
}
