...
func TestCardBuilder_Build(t *testing.T) {
	card := New("TestAgent", "A test agent", "http://localhost:9000/a2a",
		WithVersion("2.0.0"),
...
func TestCardBuilder_WithTools(t *testing.T) {
	...
	card := New("ToolAgent", "Agent with tools", "http://localhost:9000").
		SetTools(tools).
		Build()
...
func TestCardBuilder_WithExplicitSkills(t *testing.T) {
	card := New("SkillAgent", "Agent with explicit skills", "http://localhost:9000").
...
func TestCardBuilder_DefaultValues(t *testing.T) {
	card := New("Minimal", "Minimal agent", "http://localhost:9000").Build()
...
func TestCardBuilder_WithSecurity(t *testing.T) {
	...
	card := New("TestAgent", "A test agent", "https://localhost:9000/a2a",
