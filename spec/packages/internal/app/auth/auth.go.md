...
Implementation Comments: Auth resolves provider credentials from auth.json, deterministic env, and bounded command execution in the app owner without network calls.
