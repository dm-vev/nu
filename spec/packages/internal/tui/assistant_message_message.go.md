# `internal/tui/assistant_message_message.go`
...
- `AssistantMessageNew` creates a text-only assistant message.
- `NewAssistantMessageFromMessage` copies structured parts from `internal/tui` message state.
...
### `func AssistantMessageNew(value string, opts AssistantMessageOptions) *AssistantMessage`
...
### `func NewAssistantMessageFromMessage(value Message, opts AssistantMessageOptions) *AssistantMessage`
