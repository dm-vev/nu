# `internal/tui/terminal_size_other.go`

## Status

Current: IMPLEMENTED_UNCOMMITTED
Implementation Commit: pending TUI commit; user requested no commits until TUI is complete.
Implementation Comments: Return fallback size outside Unix.
...
Return fallback size outside Unix.
...
Logic:
- Return fallback dimensions on platforms without a Unix terminal size syscall.
