# `internal/tui/components/assistantmessage/message_test.go`
...
- [x] Test file is runnable with `go test ./internal/tui/components/assistantmessage`.
...
### `TestAssistantMessageRendersTextAndZone`
...
### `TestAssistantMessageRendersPartsWithoutZoneWhenToolExists`
