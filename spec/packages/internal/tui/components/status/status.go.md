# `internal/tui/components/status/status.go`
...
### `func New(style func(string) string, frameSet ...string) *Status`
...
Acceptance:
- `TestStatusStepAnimatesLabel` fails if status frames stop changing.
