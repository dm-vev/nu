# `internal/tui/components/toolblock/toolblock_test.go`
...
### `TestToolBlockRendersBashCommandAndOutput`
...
### `TestToolBlockRendersFailedCommandWithErrorBackground`
...
### `TestToolBlockRendersPatchDiffColors`
