...
type ToolRestrictionGuardrail struct {
	allowedTools []string
	action       GuardrailAction
	regex        *regexp.Regexp
}

// NewToolRestrictionGuardrail creates a tool restriction guardrail.
func NewToolRestrictionGuardrail(allowedTools []string, action GuardrailAction) *ToolRestrictionGuardrail {
...
func (t *ToolRestrictionGuardrail) Type() GuardrailType {
	return GuardrailTypeToolRestriction
}

// CheckRequest checks if a request violates the guardrail
func (t *ToolRestrictionGuardrail) CheckRequest(ctx context.Context, request string) (bool, string, error) {
...
func (t *ToolRestrictionGuardrail) CheckResponse(ctx context.Context, response string) (bool, string, error) {
...
func (t *ToolRestrictionGuardrail) Action() GuardrailAction {
	return t.action
}
