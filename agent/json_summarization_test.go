...
func (m *mockLLMForIntegration) Generate(ctx context.Context, prompt string, options ...contracts.GenerateOption) (string, error) {
	m.callCount++
...
func (m *mockLLMForIntegration) GenerateWithTools(ctx context.Context, prompt string, tools []contracts.Tool, options ...contracts.GenerateOption) (string, error) {
	return m.Generate(ctx, prompt, options...)
}

func (m *mockLLMForIntegration) GenerateDetailed(ctx context.Context, prompt string, options ...contracts.GenerateOption) (*contracts.LLMResponse, error) {
...
func (m *mockLLMForIntegration) GenerateWithToolsDetailed(ctx context.Context, prompt string, tools []contracts.Tool, options ...contracts.GenerateOption) (*contracts.LLMResponse, error) {
...
func TestJSONConcatenationPrevention(t *testing.T) {
	...
	conversationMemory := conversation.NewConversationBuffer()
	...
	responseFormat := llm.NewStructuredResponseFormat(TestResponse{})
